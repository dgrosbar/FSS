...
def entropy_approximation(compatability_matrix, lamda, mu, check_every=10**2, max_iter=10**8, epsilon=10**-7, pad=False, ret_all=False, prt=True):
...
# \begin{bmatrix}
# &p_{1}^{1}&&p_{1}^{2}&p_{1}^{3}&p_{1}^{4}&p_{1}^{4} \\
# p_{2}^{1}&p_{2}^{2}&p_{2}^{3}&p_{2}^{4}&p_{2}^{4} \\
# p_{3}^{1}&p_{3}^{2}&p_{3}^{3}&p_{3}^{4}&p_{3}^{4} \\
# p_{4}^{1}&p_{4}^{2}&p_{4}^{3}&p_{4}^{4}&p_{4}^{4} \\
# p_{5}^{1}&p_{5}^{2}&p_{5}^{3}&p_{5}^{4}&p_{5}^{4} \\
# \end{bmatrix}
